...
enum RTCGeometryType
{
  ...
  RTC_GEOMETRY_TYPE_ROUND_CATMULL_ROM_CURVE = 48, // round (tube-like) Catmull-Rom curves
  RTC_GEOMETRY_TYPE_FLAT_CATMULL_ROM_CURVE  = 49, // flat (ribbon-like) Catmull-Rom curves
  RTC_GEOMETRY_TYPE_NORMAL_ORIENTED_CATMULL_ROM_CURVE  = 50, // flat normal-oriented Catmull-Rom curves
  
  RTC_GEOMETRY_TYPE_SPHERE_POINT = 56,
  RTC_GEOMETRY_TYPE_DISC_POINT = 57,
  RTC_GEOMETRY_TYPE_ORIENTED_DISC_POINT = 58,
